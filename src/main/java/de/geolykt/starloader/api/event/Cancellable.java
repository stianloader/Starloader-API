...
public interface Cancellable {
    ...
    /**
     * Queries whether the event has been cancelled, if it returns true the event should
    ...
    /**
     * Sets the cancellation state of the event, if it is true the event should not be processed any further.
